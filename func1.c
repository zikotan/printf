...
/**
 * pr_unsigned - it prints an unsigned number
...
/**
 * pr_octal - it prints an unsigned number in octal notation
 * @types: the list of arguments
 * @buf: the buffer array to handle print
 * @fl:  it calculates active flags
 * @wid: the width
...
/**
 * pr_hex - it prints an unsigned number in hexadecimal notation
 * @types: the list of arguments
 * @buf: the buffer array to handle print
 * @fl:  it calculates active flags
 * @wid: the width
...
/**
 * pr_hexa_upper - it prints an unsigned number in upper hexadecimal notation
 * @types: the list of arguments
 * @buf: the buffer array to handle print
 * @fl:  it calculates active flags
 * @wid: the width
...
/**
 * pr_hexa - it prints a hexadecimal number in lower or upper
 * @types: the list of arguments
